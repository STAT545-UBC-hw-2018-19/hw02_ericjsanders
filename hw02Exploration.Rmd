...
-|-|-|-|-
Age | `r mean(Chile$age)`| `r sd(Chile$age)` | `r min(Chile$age)`| `r max(Chile$age)`
Income | `r mean(Chile$income)`| `r sd(Chile$income)` | `r min(Chile$income)`| `r max(Chile$income)`
...
-|-|-|-
Sex | M | `r nrow(filter(Chile,sex=='M'))` | `r nrow(filter(Chile,sex=='M'))/nrow(Chile)`
\ | F | `r nrow(filter(Chile,sex=='F'))` | `r nrow(filter(Chile,sex=='F'))/nrow(Chile)`
Education | P | `r nrow(filter(Chile,education=='P'))` | `r nrow(filter(Chile,education=='P'))/nrow(Chile)`
\ | S | `r nrow(filter(Chile,education=='S'))` | `r nrow(filter(Chile,education=='S'))/nrow(Chile)`
\ | PS | `r nrow(filter(Chile,education=='PS'))` | `r nrow(filter(Chile,education=='PS'))/nrow(Chile)`
Vote | A | `r nrow(filter(Chile,vote=='A'))` | `r nrow(filter(Chile,vote=='A'))/nrow(Chile)`
\  | N | `r nrow(filter(Chile,vote=='N'))` | `r nrow(filter(Chile,vote=='N'))/nrow(Chile)`
\  | U | `r nrow(filter(Chile,vote=='U'))` | `r nrow(filter(Chile,vote=='U'))/nrow(Chile)`
\  | Y | `r nrow(filter(Chile,vote=='Y'))` | `r nrow(filter(Chile,vote=='Y'))/nrow(Chile)`
